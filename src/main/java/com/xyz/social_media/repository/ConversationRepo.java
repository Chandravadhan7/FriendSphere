...
public interface ConversationRepo extends JpaRepository<Conversation,Long> {
    ...
    @Query(value = "select * from conversation c join conversation_participants cp on c.conversation_id = cp.conversation_id where cp.user_id= :userId",nativeQuery = true)
